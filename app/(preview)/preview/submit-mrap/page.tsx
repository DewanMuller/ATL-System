...
export default async function PreviewSubmitMrapPage({
  ...
  const [liveOkrAverage, pulse, existingReview] = await Promise.all([
    ...
    <div className="flex flex-col gap-6 pb-12">
      ...
      <div className="rounded-xl border border-black/10 bg-white p-5 dark:border-white/10 dark:bg-zinc-950">
        ...
        >
          ...
          <TextArea label="Highlights" name="highlights" defaultValue={existingReview?.highlights ?? undefined} />
          <TextArea
          ...
          />
          <TextArea label="Priorities for next month" name="priorities" defaultValue={existingReview?.priorities ?? undefined} />
          <button
            type="submit"
